...
def test_sign_up_facebook_valid_access_token(rest_client, mocker, fb_access_token):
    # Testing
    ...
    response = rest_client.post(reverse('register_by_access_token', args=('facebook',)), data={
...
# @social_auth_vcr.use_cassette(match_on=('method', 'path'))
# @pytest.mark.django_db
# def test_sign_up_facebook_valid_access_token_missing_email(rest_client, mocker, fb_access_token):
#     """
